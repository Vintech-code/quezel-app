        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.3em] text-(--coffee-brown)">New password</p>
            </div>
          </div>
          <Link
            to="/auth/sign-in"
      ...
      <main className="px-6 py-16">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <section className="rounded-[32px] border border-border bg-(--cream-white) p-8 shadow-diffuse">
            <h2 className="font-display text-3xl">Reset password</h2>
          ...
          <section className="relative overflow-hidden rounded-[32px] border border-(--soft-gold) bg-(--parchment) p-10 shadow-diffuse">
            ...
            <p className="text-xs uppercase tracking-[0.3em] text-(--coffee-brown)">Almost there</p>
            <h1 className="mt-3 font-display text-4xl">Fresh starts taste better</h1>
            <p className="mt-4 text-sm text-muted-foreground">
              After you reset your password, we will take you back to sign in.
            </p>
            <div className="mt-10 grid gap-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                <span className="h-2 w-2 rounded-full bg-(--coffee-brown)" />
                Keep it safe in a password manager.
              </div>
            </div>
          </section>
        </div>
